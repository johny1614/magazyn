...
class Testing(unittest.TestCase):
    ...
    #     self.assertAlmostEqual(env.agents[0].memories[60].reward, 10, 0)
    #     self.assertAlmostEqual(env.agents[0].memories[61].reward, 20, 0)
    #     self.assertAlmostEqual(env.agents[0].memories[62].reward, 30, 0)
    #     exportData = ExportData(learningMethod='Monte Carlo TODO', learningEpochs=0, nets=env.global_memories,
    ...
    #     self.assertAlmostEqual(env.agents[0].memories[62].reward, 30, 0)
    #     exportData = ExportData(learningMethod='Monte Carlo TODO', learningEpochs=0, nets=env.global_memories,
    #                             netName='net14', densityName='test_no_5')
    #     exportData.saveToJson()
