...
def p_start(previous_densities):
    return 0.25 *(3*previous_densities[0]+previous_densities[1])-0.5*(f(previous_densities[1])-f(previous_densities[0])-2*gamma_in)
...
def p_last(previous_densities):
    ...
    return 0.25*(3*previous_densities[n]+previous_densities[n-1])-0.5*(2*gamma_out-f(previous_densities[n])-f(previous_densities[n-1]))
