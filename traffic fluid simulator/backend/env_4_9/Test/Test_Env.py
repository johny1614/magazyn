...
class Testing(unittest.TestCase):
    ...
    #
    # def test_no_2_pass_action_0_0_0_long_time_then_1_1_1(self):
    ...
    #     exportData.saveToJson()
    #
    # def test_no_4_pass_action_0_0_0_long_time_then_1_1_1_long_time_then_2_2_2(self):
    ...
    #                              [0, 0, 0])  # Po operacji w chwili 60 mamy taka faze dla stanu w chwili 60
    #             self.assertEqual([agent.memories[t].state.actual_phase for agent in agents],
    #                              [0, 0, 0])  # Po operacji w chwili 60 mamy taka faze dla stanu w chwili 60
    #         if t == 60 or t == 61:
    #             self.assertEqual([agent.actual_phase for agent in agents], [orange, orange, orange])
    #             self.assertEqual([agent.memories[t].state.actual_phase for agent in agents], [orange, orange, orange])
    #         if 62 <= t <= 69:
    #             self.assertEqual([agent.actual_phase for agent in agents], [1, 1, 1])
    #             self.assertEqual([agent.memories[t].state.actual_phase for agent in agents], [1, 1, 1])
    #         if t == 70 or t == 71:
    #             self.assertEqual([agent.actual_phase for agent in agents], [orange, orange, orange])
    #             self.assertEqual([agent.memories[t].state.actual_phase for agent in agents], [orange, orange, orange])
    #         if t >= 72:
    ...
    #     exportData = ExportData(learningMethod='Monte Carlo TODO', learningEpochs=0, nets=env.global_memories,
    #                             netName='net4', densityName='test_no_5')
    #     exportData.saveToJson()
