...
class Testing(unittest.TestCase):
    ...
    def test_no_5_pass_action_1_1_1_long_time_then_2_2_2_long_time_then_3_3_3(self):
        # TESTUJEMY: rewardy
        max_time = 90
        agents = get_SmartAgents()
        Globals().time = 0
        ...
        self.assertAlmostEqual(agents[0].memories[60].reward, 36.95, 0)
        self.assertAlmostEqual(agents[0].memories[61].reward, 39.14, 0)
        self.assertAlmostEqual(agents[0].memories[62].reward, 51.20, 0)
